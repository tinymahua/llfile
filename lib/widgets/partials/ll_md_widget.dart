...
//   LlTreeNode<MdObject>? _currentTreeNode;
//
...
//       _mdTreeController!.expand(_currentTreeNode!);
//       await _mdConfigDb.expandMdObject(_currentTreeNode!.data!.id);
//     }
//   }
//
...
//   }
//
//   addTreeNodeChildren(LlTreeNode<MdObject> node, List<MdObject> mdObjects) async {
//     node.children.addAll(List.generate(mdObjects.length, (i){
//       return LlTreeNode<MdObject>(
//           key: Key(mdObjects[i].id),
//           data: mdObjects[i],
//           titleWidget: Text(mdObjects[i].objectName),
//           children: []);
//     }));
//     _mdTreeController!.rebuild();
//     _mdTreeController!.expand(node);
//     await _mdConfigDb.expandMdObject(node.data!.id);
//   }
//
...
//
//
//                       await addTreeNodeChildren(currentNode, [newMdObject]);
//                       // setState(() {
...
//                       // // await defaultExpandTreeNodes();
//                       // print("When created: ${_mdTreeController!.getExpansionState(currentNode)}");
//                       // if (!_mdTreeController!.getExpansionState(currentNode)){
//                       //   _mdTreeController!.toggleExpansion(currentNode);
//                       // }
