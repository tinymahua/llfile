...
import 'package:llfile/llpkgs/ll_buttons/ll_buttons.dart';
import 'package:flutter_localizations/flutter_localizations.dart';

part 'll_tab.dart';

const double _kMinTileWidth = 80.0;
const double _kMaxTileWidth = 120.0;
const double _kTileHeight = 34.0;
const double _kButtonWidth = 32.0;

class LlTabView extends StatefulWidget {
  /// Creates a tab view.
  ///
  ...
  const LlTabView({
    ...
    this.closeButtonVisibility = LlCloseButtonVisibilityMode.always,
    this.tabWidthBehavior = LlTabWidthBehavior.equal,
    this.header,
    this.footer,
  ...
  final LlCloseButtonVisibilityMode closeButtonVisibility;
  ...
  @override
  State<StatefulWidget> createState() => _LlTabViewState();

}

class _LlTabViewState extends State<LlTabView> {
  Timer? closeTimer;
  ...
  @override
  void didUpdateWidget(LlTabView oldWidget) {
  ...
  Widget _tabBuilder(
    ...
    final Widget child = GestureDetector(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        Flexible(
          fit: widget.tabWidthBehavior == LlTabWidthBehavior.equal
              ? FlexFit.tight
              : FlexFit.loose,
          child: tabWidget,
        ),
    ...
    final minWidth = () {
      switch (widget.tabWidthBehavior) {
        case LlTabWidthBehavior.sizeToContent:
        case LlTabWidthBehavior.compact:
          return null;
        default:
